...
from sqlalchemy.orm  import relationship # function from the SQLAlchemy library used to define relationships between database tables.
...
Base.metadata.create_all(engine) #creating    
